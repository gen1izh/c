...
/*****************************************************************************
 *	below are the definitions to set up PIC24F32KA304 communication with the 
 *  LCD
 *****************************************************************************/
	...
	#define TRIS_LCD_E		TRISBbits.TRISB7
	#define TRIS_LCD_RW		TRISBbits.TRISB8
	#define	TRIS_LCD_RS		TRISBbits.TRISB9
	
	#define setLCD_RS()		LATBbits.LATB9 = 1		//set Register Select bit
	#define clrLCD_RS()		LATBbits.LATB9 = 0		//clear Register Select bit
	#define setLCD_RW()		LATBbits.LATB8 = 1		//set Read/Write bit
	#define clrLCD_RW()		LATBbits.LATB8 = 0		//clear Read/Write bit
	#define setLCD_E()		LATBbits.LATB7 = 1		//set Enable bit
	#define clrLCD_E()		LATBbits.LATB7 = 0		//clear Enable bit

/*****************************************************************************
 * Function: Send_LCD_Data
 *
 * Preconditions: None.
 *
 * Overview: This function sends data to the LCD for display
 *
 * Input: character
 *
 * Output: None.
...
/*****************************************************************************
 * Function: Send_LCD_Command
 *
 * Preconditions: None.
 *
 * Overview: This function sends commands to the LCD
 *
 * Input: character
 *
 * Output: None.
